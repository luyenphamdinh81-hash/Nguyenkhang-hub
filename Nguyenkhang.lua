...
ImageButton.Image = "http://www.roblox.com/asset/?id=105800442735557"  -- 👈 đổi ID ảnh nút mở menu tại đây (ảnh roblox)
...
local Window = Fluent:CreateWindow({
	Title = "banana NKH =}",         -- 👈 đổi thành tên script của bạn
...
Tabs.Main1:AddButton({
	Title = "Banana NKH",                             -- 👈 tên nút hiển thị
